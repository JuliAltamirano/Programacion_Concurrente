...
public class Main {
	...
	private static int SV_RATE1 = 0;
	private static int SV_RATE2 = 0;
	private static int LOG_DELAY = 100;
	
	private static String ROOT = "C:/Disco local/Carpetas/Facu/Facultad/4to Año - 2019/1° semestre/Programación Concurrente/Trabajos Prácticos/TP3_Aichino_Altamirano_Argayo_Bosack/Codigo_TP3";
